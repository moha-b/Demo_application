                    ...
                    Container(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(labelText: "Password",
                            ...
                            enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Color(0xFFC988EB),)),
                            focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Color(0xFFC988EB),),
                            borderRadius: BorderRadius.circular(28)),
                            prefixIcon: Icon(Icons.password, color: Color(0xFFC988EB),),
                            suffixIcon: Icon(Icons.remove_red_eye, color: Color(0xFFC988EB),)
                        ),
